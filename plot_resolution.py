...
if __name__ == "__main__":
    ...
    input_file = "output/CLD_1.5T_Zmumu_ecm240_p_pt.root"

    # --- Plot for total momentum resolution ---
    compute_res(
        input_file=input_file,
        hist_name="muons_res_p",
        output_name="resolution_CLD_1.5T_Zmumu_ecm240_p"
    )

    # --- Plot for transverse momentum resolution ---
    compute_res(
        input_file=input_file,
        hist_name="muons_res_pt",
        output_name="resolution_CLD_1.5T_Zmumu_ecm240_pt"
    )
